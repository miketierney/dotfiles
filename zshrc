...
plugins=(brew bundler cap cloudapp gem git git-flow heroku npm osx pow rails rails3 ruby rvm svn textmate)
...
export NODE_PATH="/usr/local/bin:/usr/local/sbin:/usr/local/mysql/bin:/usr/local/lib/node:/usr/local/lib/node_modules:/usr/local/bin/npm:/Users/mike/.npm"
